import { INITIAL_TELEMETRY, TELEMETRY_HISTORY } from '../data/mockData';

export default function LoadAnalysisView({ telemetry = INITIAL_TELEMETRY, history = TELEMETRY_HISTORY }) {
  return (
    <div>
      {/* Header */}
