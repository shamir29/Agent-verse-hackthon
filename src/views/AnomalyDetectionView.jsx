...
import { AlertTriangle, ShieldAlert, CheckCircle2, Zap, ArrowRight, DollarSign } from 'lucide-react';

export default function AnomalyDetectionView({ anomalies, onResolveAnomaly }) {
  return (
    <div>
      {/* Header */}
